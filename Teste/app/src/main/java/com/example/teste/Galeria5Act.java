...
public class Galeria5Act extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.voltar= (android.widget.ImageButton) this.findViewById(R.id.btnvoltarglr5);
        this.voltar.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) { Galeria5Act.this.openGaleriaMenuActivity();
            }
        });
    }
    ...
    public boolean onTouchEvent(MotionEvent touchEvent) {
        switch (touchEvent.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                y2 = touchEvent.getY();
                if (x1 > x2) {
                    Intent i = new Intent(Galeria5Act.this, Galeria6Act.class);
                    startActivity(i);
                } else if (x1 < x2) {
                    Intent i = new Intent(Galeria5Act.this, Galeria4Act.class);
                    startActivity(i);
                }
                break;
        }
