...
public class Email8Act extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.actemail8);
        ...
        this.voltar.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) { Email8Act.this.openMainActivity();
            }
        });
        ...
        this.menu.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) { Email8Act.this.openEmailMenu();
            }
        });
    }
