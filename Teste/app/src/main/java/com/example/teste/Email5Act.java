...
public class Email5Act extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.actemail5);

        this.voltar = (android.widget.ImageButton) this.findViewById(R.id.btnmenu17);
        this.voltar.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) { Email5Act.this.openMainActivity();
            }
        });
        ...
        this.menu.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) { Email5Act.this.openEmailMenu();
            }
        });
    }
