...
public class Email6Act extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.actemail6);

        this.voltar = (android.widget.ImageButton) this.findViewById(R.id.btnmenu18);
        this.voltar.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) { Email6Act.this.openMainActivity();
            }
        });
        ...
        this.menu.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) { Email6Act.this.openEmailMenu();
            }
        });
    }
