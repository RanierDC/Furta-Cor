...
public class Galeria11Act extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.actgaleria11);
        this.menu= (android.widget.ImageButton) this.findViewById(R.id.btnmenugf11);
    ...
    public boolean onTouchEvent(MotionEvent touchEvent) {
        switch (touchEvent.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                y2 = touchEvent.getY();
                if (x1 < x2) {
                    Intent i = new Intent(Galeria11Act.this, Galeria10Act.class);
                    startActivity(i);
                }
                break;
        }
